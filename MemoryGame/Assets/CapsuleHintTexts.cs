...
public class CapsuleHintTexts : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        l1.Add("重置本关卡？"); l1.Add("好"); l1.Add("不要"); 
        capsuleHintTextContent_chn.Add(l1);

        List<string> l2 = new List<string>();
        l2.Add("重置所有进度？"); l2.Add("好"); l2.Add("不要"); 
        ...
        l4.Add("回到主菜单（丢失本关卡进度）？"); l4.Add("好"); l4.Add("不要"); 
        ...
        capsuleHintTextContent_eng.Add(l0);

        List<string> l1e = new List<string>();
        l1e.Add("Reset current level?"); l1e.Add("yes"); l1e.Add("no");
        capsuleHintTextContent_eng.Add(l1e);

        List<string> l2e = new List<string>();
        l2e.Add("Reset entire game?"); l2e.Add("yes"); l2e.Add("no");
        ...
        l4e.Add("Return to main menu (you will lose progress on current level)?"); l4e.Add("yes"); l4e.Add("no");
